...
add_action('wp_enqueue_scripts', function () {
  ...
  wp_enqueue_style( 'theme/main.css', dist_path('main.css'), false, null);
  wp_enqueue_script( 'theme/main.js', dist_path('main.js'), ['jquery'], null, true);
}, 100);
...
add_action( 'after_switch_theme', '_nik_on' );
...
add_action( 'after_setup_theme', '_nik_setup' );